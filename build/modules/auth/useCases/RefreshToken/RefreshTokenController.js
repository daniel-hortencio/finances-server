...
class RefreshTokenController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const refreshUseCase = tsyringe_1.container.resolve(RefreshTokenUseCase_1.RefreshTokenUseCase);
            const new_token = yield refreshUseCase.execute({ id_refresh_token, id_user });
